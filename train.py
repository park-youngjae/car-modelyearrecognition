...
hyp = {'giou': 3.54,  # giou loss gain
       ...
       'lr0': 0.005, #0.01,  # initial learning rate (SGD=5E-3, Adam=5E-4)
       'lrf': 0.0005,  # final learning rate (with cos scheduler)
       'momentum': 0.937,  # SGD momentum
       'weight_decay': 0.005, #0.0005,  # optimizer weight decay
...
def train(hyp):
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            # Loss
#             print(paths)
#             print(targets[:,1].detach().cpu().numpy())
        ...
        if save:
            ...
            torch.save(ckpt, last.replace('last','epoch_'+str(epoch))) #torch.save(ckpt, last)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='pretrained/yolov3-spp-final.cfg', help='*.cfg path')
    ...
    parser.add_argument('--weights', type=str, default='weights/yolov3-spptics.pt', help='initial weights path')
