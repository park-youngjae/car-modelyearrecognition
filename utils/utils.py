...
#             print(c)
#             print(c.max() , c.argmax().item(), b[c.argmax().item()])
...
fontpath = "./utils/MALGUNBD.TTF"



def plot_one_box_sibal(x, img, color=None, label=None, line_thickness=None):
    # Plots one bounding box on image img
    tl = line_thickness or round(0.002 * (img.shape[0] + img.shape[1]) / 2) + 1  # line/font thickness
    
    font = ImageFont.truetype(fontpath, tl * 25 // 3)
    ...
    if label:
        ...
        draw.text((c1[0], c1[1] - tl * 25 // 3),  label, font=font, fill=(255,255,255,0))
